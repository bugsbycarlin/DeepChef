...
for punctuation_mark in punctuation:
  if punctuation_mark in ingredients_generator.dictionary:
    del ingredients_generator.dictionary[punctuation_mark]
  if punctuation_mark in title_generator.dictionary:
    del title_generator.dictionary[punctuation_mark]
...
def generate_recipe():
  ...
  print
  print
  print title_generator.generate(2).title()
  print "Rating: %s stars" % weightedChoice(stars)
  print "About:"
  print blurb_generator.generate(10)
  print
  print "Ingredients:"
  for i in range(0, random.randint(3,10)):
    ingredient = ingredients_generator.generate(3)
    for i in range(0,3):
  ...
  for i in range(0, random.randint(3,8)):
    print str(i + 1) + ". " + directions_generator.generate(9).replace("  "," ")
...
def generate_recipe_html():
  ...
  print "<br/>"
  print "<br/>"
  print "<b>" + title_generator.generate(2).title() + "</b><br/><br/>"
  print "Rating: <img src=\"%s_star.png\" height=\"20\" width=\"95\" style=\"margin-bottom: -5px;\"/><br/>" % weightedChoice(stars)
  print "About:<br/>"
  print blurb_generator.generate(10) + "<br/>"
  print "<br/>"
  ...
  print "Directions:<br/>"
  for i in range(0, random.randint(3,8)):
    print str(i + 1) + ". " + directions_generator.generate(9).replace("  "," ") + "<br/>"
    #print str(i + 1) + ". " + random.choice(directions_pool)
    print "<br/>"
  print "<br/>"
  print "<br/>"
